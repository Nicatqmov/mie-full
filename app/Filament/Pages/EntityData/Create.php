...
class Create extends Page implements Forms\Contracts\HasForms
{
    use Forms\Concerns\InteractsWithForms;

    protected static ?string $navigationIcon = 'heroicon-o-plus';
    protected static string $view = 'filament.pages.entity-data.create';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $slug = 'entity-data/create';
    ...
    public function create(): void
    {
        ...
        $model = (new DynamicModel())->setTableName($actualTableName);
        $model->fill($data);
        $model->save();
